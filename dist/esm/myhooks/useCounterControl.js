...
export var useCounterControl = function useCounterControl(max, initCounter, duration) {
  ...
  var handleDecrease = useCallback(
    function () {
  ...
  var handleIncreaseWithDebounce = useCallback(throttle(handleIncrease, duration), [
    handleIncrease,
    duration,
  ]);
  var handleDecreaseWithDebounce = useCallback(throttle(handleDecrease, duration), [
    handleDecrease,
    duration,
  ]);
  return {
